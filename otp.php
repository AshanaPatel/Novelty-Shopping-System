	...
	<div class="container">
		<div class="row" >
				...
				<div class="cart-page-container fix">
							...
							<div class="cart-page-title text-center"><h1>OTP Password</h1></div>
							<?php 
			...
			<font color="red"><?php if(isset($_SESSION['error']) && $_SESSION['error']!=""){echo $_SESSION['error'];unset($_SESSION['error']);} ?></font>
				...
				<form id="" method="post" action="otp_process.php" class="moon-form">
					
					<div class="input-box">
						<label>OTP:</label>
						<input type="text" name="txtopt" id="temail" placeholder="Enter OTP" class="form-control " >

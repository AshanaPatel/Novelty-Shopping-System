							...
							<li class="closed"><a href="#"><?php echo $resultcat1['maincategory_name']; ?></a>
								<ul>
									...
									<?php 
										...
										while($resultsub1=$subcat1->fetch_array()){ ?>
										<li><a href="#"><?php echo "<option value=".$resultsub1['category_id'].">".$resultsub1['category_name']."</option>"; ?></a></li>
								<?php } ?>	
                                </ul>								
							</li>										
						</ul>
			...
			<div class="col-md-10 col-sm-9 text-center">
				...
				<div class="brand-slider">
						...
						<?php
							...
							while($result=$query->fetch_array()){
						?>
							<a href="shopbrand.php?sbid=<?php echo $result['brand_id']; ?>" ><div class="brand-item"><image src="image/<?php echo $result['image']; ?>"  width="150px" height="120px" />
							</div></a>
